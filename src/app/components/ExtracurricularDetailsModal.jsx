...
export default function ExtracurricularDetailsModal({ activity, onClose }) {
    ...
    >
      ...
      >
          ...
          >
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: renderDescriptionWithLinks(activity.description)
              }}
            />
          </div>
        )}
        ...
        <div className="flex gap-3">
          <a
            href={`https://www.google.com/search?q=${encodeURIComponent(activity.name + ' extracurricular activity')}`}
            target="_blank"
          ...
          >
            ...
            <span>Search for More Info</span>
          </a>
        </div>
      </div>
    </div>
